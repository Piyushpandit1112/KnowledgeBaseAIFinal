            ...
            using (var connection = new SqlConnection(ConnectionString))
            {
                ...
                using (SqlTransaction transt = connection.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        data.Columns["Column18"].ColumnName = "DG_CDR";
                        data.Columns["Column19"].ColumnName = "DSC_CDR";
                        ...
                        objbulk.ColumnMappings.Add("DG_CDR", "DG_CDR");
                        objbulk.ColumnMappings.Add("DSC_CDR", "DSC_CDR");
